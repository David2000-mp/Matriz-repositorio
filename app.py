...
def main():
    ...
    with st.sidebar:
        ...
        selected = st.radio(
            "Navegación", menu_options, index=idx_menu, key="page_selection"
        )
        st.divider()
        st.caption("v2.1.0 • Sprint 5")

    # --- ENRUTADOR DE VISTAS ---
    filtro = st.session_state.get(
