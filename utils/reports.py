...
def generate_pdf_report(school_name: str, period: str, kpis: Dict[str, Dict[str, Any]], anomalies: List[Any], health_score: float) -> bytes:
    ...
    pdf.cell(0, 6, 'Reporte generado por CHAMPILYTICS', 0, 1)
...
def generate_html_report(school_name: str,
    ...
    El layout genera:
    - Banner principal con color #002855
    ...
    css = """
        <style>
            :root{--marista-blue:#002855; --marista-amber:#FFB81C; --alert-red:#d9534f; --alert-green:#5cb85c;}
    ...
    parts.append('<footer style="margin-top:20px;color:#666;font-size:12px">Reporte generado por CHAMPILYTICS</footer>')
